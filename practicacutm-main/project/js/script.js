...
if (loginOverlay) {
    ...
    if (loginForm) {
        loginForm.addEventListener('submit', (e) => {
            ...
            localStorage.setItem('v_energy_user', numeDinEmail);
    ...
    if (registerForm) {
        registerForm.addEventListener('submit', (e) => {
            ...
            localStorage.setItem('v_energy_user', numeComplet);
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const userSalvat = localStorage.getItem('v_energy_user');
    if (userSalvat) {
        afiseazaNumeUtilizator(userSalvat);
    }
